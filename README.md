## TODO EN UNO SOLO :))) (EN MAC)
```javascript
// Paso 1: Llenar "Ocupación e Ingreso" (_ngcontent-qky-c88)
setTimeout(() => {
    const selectsC88 = document.querySelectorAll('[_ngcontent-qky-c88] select');
    ...
    const inputsC88 = document.querySelectorAll('[_ngcontent-qky-c88] input');
    ...
    // Paso 2: Llenar todos los selects con '3' (_ngcontent-qky-c93)
    setTimeout(() => {
        const selectsC93 = document.querySelectorAll('[_ngcontent-qky-c93] select');
        ...
        // Paso 3: Llenar "Vivienda" (_ngcontent-qky-c86)
        setTimeout(() => {
            const selectsC86 = document.querySelectorAll('[_ngcontent-qky-c86] select');
            ...
            // Paso 4: Marcar solo "MANUALIDADES" (_ngcontent-qky-c90)
            setTimeout(() => {
                const inputsC90 = document.querySelectorAll('[_ngcontent-qky-c90] input');
                ...
                // Paso 5: Seleccionar "NO" en "VIOLENCIA Y DISCRIMINACIÓN" (_ngcontent-qky-c91)
                setTimeout(() => {
                    const selectsC91 = document.querySelectorAll('[_ngcontent-qky-c91] select');
                    ...
                    // Paso 6: Seleccionar "NO" en "OBSERVACIONES" (_ngcontent-qky-c92)
                    setTimeout(() => {
                        const selectsC92 = document.querySelectorAll('[_ngcontent-qky-c92] select');
                        ...
                        const inputsC92 = document.querySelectorAll('[_ngcontent-qky-c92] input');
                        ...
                        // Paso 7: Llenar "ELABORACIÓN" (_ngcontent-qky-c94)
                        setTimeout(() => {
                            const selectsC94 = document.querySelectorAll('[_ngcontent-qky-c94] select');
                            ...
                            const inputsC94 = document.querySelectorAll('[_ngcontent-qky-c94] input');
...
## TODO EN UNO SOLOOO :)))) (EN LAP DE MAMA)
```javascript
